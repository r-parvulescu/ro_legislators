...
# NB: legislator = 1 means that the minister was also, at any point since 2000, a legislator; this needs to be
#     marked because in Romania cabinet ministers need not also be legislators
# NB: I dont' count PSD government in 2000 since it was invested on December 28, 2000
conv_min_info = {
    'NĂSTASE Adrian': {'min mandate': (2001, 2002, 2003, 2004),
                       'party during min mandate': 'PSD',
                       'legislator': 1,
                       'conviction date': (2012, 2014)},
    'CHIUARIU Tudor Alexandru': {'min mandate': (2007),
                                 'party during min mandate': 'PNL',
                                 'legislator': 1,
                                 'conviction date': 2014},
    'NIŢĂ Constantin': {'min mandate': (2008, 2009, 2012, 2013, 2014),
                        'party during min mandate': 'PSD',
                        'legislator': 1,
                        'conviction date': 2018},
    'DOBRIŢOIU Corneliu': {'min mandate': (2012),
                           'party during min mandate': 'PNL',
                           'legislator': 1,
                           'conviction date': 2016},
    'POPESCU Dan Ioan': {'min mandate': (2001, 2002, 2003, 2004),
                         'party during min mandate': 'PSD',
                         'legislator': 1,
                         'conviction date': 2011},
    'ŞOVA Dan Coman': {'min mandate': (2012, 2013, 2014),
                       'party during min mandate': 'PSD',
                       'legislator': 1,
                       'conviction date': 2018},
    'REMEŞ Decebal Traian': {'min mandate': (2007),
                             'party during min mandate': 'PNL',
                             'legislator': 0,
                             'conviction date': 2013},
    'UDREA Elena Gabriela': {'min mandate': (2008, 2009, 2010, 2011, 2012),
                             'party during min mandate': 'PDL',
                             'legislator': 1,
                             'conviction date': 2018},
    'BERCA Gabriel': {'min mandate': (2012),
                      'party during min mandate': 'PDL',
                      'legislator': 1,
                      'conviction date': 2017},
    'SANDU Gabriel': {'min mandate': (2008, 2009, 2019),
                      'party during min mandate': 'PDL',
                      'legislator': 1,
                      'conviction date': 2016},
    'COPOS Gheorghe': {'min mandate': (2004, 2005, 2006),
                       'party during min mandate': 'PC',
                       'legislator': 1,
                       'conviction date': 2014},
    'ŞEREŞ Ioan Codruţ': {'min mandate': (2004, 2005, 2006),
                          'party during min mandate': 'PC',
                          'legislator': 1,
                          'conviction date': (2015, 2016)},
    'MITREA Miron Tudor': {'min mandate': (2001, 2002, 2003, 2004),
                           'party during min mandate': 'PSD',
                           'legislator': 1,
                           'conviction date': 2015},
    'IACOB RIDZI Monica Maria': {'min mandate': (2008, 2009),
                                 'party during min mandate': 'PDL',
                                 'legislator': 1,
                                 'conviction date': 2015},
    'DRAGNEA Nicolae Liviu': {'min mandate': (2009, 2012, 2013, 2014, 2015),
                              'party during min mandate': 'PSD',
                              'legislator': 1,
                              'conviction date': (2016, 2019)},
    'FENECHIU Relu': {'min mandate': (2012, 2013),
                      'party during min mandate': 'PNL',
                      'legislator': 1,
                      'conviction date': (2014, 2016)},
    'FRUNZĂVERDE Sorin': {'min mandate': (2006, 2007),
                          'party during min mandate': 'PDL',
                          'legislator': 1,
                          'conviction date': 2016},
    'FUIA Stelian': {'min mandate': (2012),
                     'party during min mandate': 'PDL',
                     'legislator': 1,
                     'conviction date': 2016},
    'NAGY Zsolt': {'min mandate': (2004, 2005, 2006, 2007),
                   'party during min mandate': 'UDMR',
                   'legislator': 0,
                   'conviction date': (2014, 2015)},
    }
